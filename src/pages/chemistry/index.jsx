			...
			<div className="bg-accent">
				<div className="container mx-auto">
					<div className="flex flex-col items-center justify-center h-screen">
						...
						<div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-6 w-full gap-5">
							{/* list materi */}
							<Link
								to="/kimia/atom"
							...
							<Link
								...
								className="hover:scale-105 transition-all duration-300 ease-in-out">
								<div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mt-14 ">
									<CircleDotDashed className="w-1/2 h-1/2 mx-auto text-gray-300 pt-10 hover:scale-105 transition-all duration-300 ease-in-out" />
									<div className="px-5 pb-5">
										<h5 className="text-center text-xl font-semibold tracking-tight text-gray-900 dark:text-white pt-10">
											Molekul
										</h5>
